...
* extension[protocol-amendment][=].extension[region].valueCode = $iso3166-2#AU-NSW "New South Wales"
...
* extension[protocol-amendment][=].extension[signatureUrl].valueUrl = "https://somelocation" 

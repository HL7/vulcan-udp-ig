...
* contact[+].purpose.coding[+] = http://terminology.hl7.org/CodeSystem/contactentity-type#ADMIN "Contact details for administrative enquiries."
...
* contact[+].purpose.coding[+] = $NCIT#CC70946 "Postal Address"

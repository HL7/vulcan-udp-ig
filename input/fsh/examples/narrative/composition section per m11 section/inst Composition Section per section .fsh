Instance: Narrative-Composition-Section-per-Section
...
* section[+]
  * title = "Section 1 - {this is the Section Title}"
  * code = $NCIT#C218514  "ICH M11 Protocol Section 1 PROTOCOL SUMMARY"
  ...
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml' xml:lang="en" lang="en"> 
      ...
      """
* section[+]
  * title = "Section 2 - {this is the Section Title}"
  ...
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml' xml:lang="en" lang="en"> 
      ...
      """
* section[+]
  * title = "Section 3 - {this is the Section Title}"

...
The terminology used by M11 is defined in the M11 Technical Specification but is made available through the NCI Thesaurus.  In this IG the terminology presented in the value sets was constructed from an expansion from the NCI thesaurus.  If the IG is loaded into a FHIR server the terminology becomes available within that server and allows for validation.  

> **Caution**
>
> **For production systems the terminology used should be based on the latest expansion from the NCI Thesaurus**.
...
#### Extracting Terminology from NCI EVS Explore

NCI provide a range of different methods of extracting codes and value sets from the NCI Thesaurus.

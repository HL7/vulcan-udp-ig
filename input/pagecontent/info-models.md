...
<div><p><a href="image-20260129164106045.png"> <img src="image-20260129164106045.png" alt="image-20260129164106045.png" style="max-width: 90%;height: auto;"/> </a> <p>
    Figure 1 : All three models drawing from the same terminology source (the NCI Thesaurus) for their set of available values for "Phase" (<i>images taken from USDM, ICH and NCI - see full images and attribution in the FHIR Representation section</i>)
    </p></p></div>

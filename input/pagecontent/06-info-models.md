...
USDM is a content model that is particularly detailed as it aims to represent all the elelments of a study in a machine readable way by specifying all the potential parameters or data elements of a study.
